        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfCooling = table.Column<int>(type: "int", nullable: true),
                    CubicMeter = table.Column<int>(type: "int", nullable: true),
                    TactsOfEngine = table.Column<int>(type: "int", nullable: true),
                    AxlesCount = table.Column<int>(type: "int", nullable: true),
                    LoadInKg = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotorcycleId = table.Column<string>(type: "nvarchar(450)", nullable: true),
