        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber2 = table.Column<string>(nullable: true),
                    PhoneNumber3 = table.Column<string>(nullable: true),
                    VipAd_PhoneNumber2 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(nullable: true),
                    BaseImageUrl = table.Column<string>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    SeatsCount = table.Column<int>(nullable: true),
                    AxlesCount = table.Column<int>(nullable: true),
                    LoadInKg = table.Column<int>(nullable: true),
                    TypeOfCooling = table.Column<int>(nullable: true),
                    CubicMeter = table.Column<int>(nullable: true),
                    TactsOfEngine = table.Column<int>(nullable: true),
                    Truck_SeatsCount = table.Column<int>(nullable: true),
                    Truck_AxlesCount = table.Column<int>(nullable: true),
                    Truck_LoadInKg = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
